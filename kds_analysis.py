...
def build_dashboard(df, analytics, promo_months, hike1_months, hike_months, output_path):
    ...
    # Benchmark SaaS: średnia retencja 1M = 46,9%
    # Źródło: Userpilot, badanie 83 firm B2B SaaS
    # https://userpilot.com/blog/month-1-retention-rate-benchmarks/
    # Uwaga: benchmark mierzy retencję użytkowników produktu, nie transakcyjną –
    # porównanie ma charakter orientacyjny
    ax4a.axhline(46.9, color=AMBER, lw=1.5, linestyle='--', alpha=0.7, zorder=2)
    ax4a.text(6.08, 47.5, 'benchmark\nSaaS\n46,9%',
    ...
    meta_lines = [
        ...
        "Benchmark retencji 1M: 46,9% (Userpilot, 83 firmy B2B SaaS; "
        "zrodlo: userpilot.com/blog/month-1-retention-rate-benchmarks). "
        "Uwaga: benchmark mierzy retencje uzytkownikow produktu, nie transakcyjna – porownanie orientacyjne."
    ]
