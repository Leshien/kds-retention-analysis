...
4. **Benchmarking** — retencja porównana do benchmarku SaaS SMB ([Baremetrics 2024](https://baremetrics.com/blog/saas-quick-ratio): 35–55% retencja 1M).
...
| Krzywe retencji per era | Linie przeżywalności z benchmarkiem SaaS (pasmo 35–55%) |
...
- Benchmark SaaS (Baremetrics 2024) dotyczy rynku globalnego; polskie benchmarki mogą się różnić.
